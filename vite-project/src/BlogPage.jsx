...
const BlogData = [
    ...
    return (
      <div className="blog-post">
        ...
        <div className="post-content">
          ...
          {isExpanded && <div className="full-content">{post.fullContent}</div>}
        </div>
      </div>
    );
  }
  ...
  function BlogGrid() {
    const [displayedPosts, setDisplayedPosts] = useState(BlogData);
    const [viewMoreClicked, setViewMoreClicked] = useState(false);
  
    const handleViewMore = () => {
      setViewMoreClicked(true);
      setDisplayedPosts((prevPosts) => [...prevPosts, ...BlogData]); 
    };
  
    const showViewMoreButton = !viewMoreClicked;
